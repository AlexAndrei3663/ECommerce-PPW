...
/**
 * Servlet Filter implementation class FiltroSegurancaAdministrador
 */
public class FiltroSegurancaAdministrador implements Filter {
     ...
     * Default constructor. 
     */
    public FiltroSegurancaAdministrador() {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		if(usuario !=null&&usuario.isLogado()&&usuario.getPapelUsuario().equals(Usuario.papelAdministrador)){
